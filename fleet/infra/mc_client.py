    ...
    def _parse_task(data: dict) -> Task:
        ...
        return Task(
            ...
            custom_fields=TaskCustomFields(
                ...
                task_readiness=int(custom.get("task_readiness") or 0),
                requirement_verbatim=custom.get("requirement_verbatim"),
                task_stage=custom.get("task_stage"),
                delivery_phase=custom.get("delivery_phase"),
                phase_progression=custom.get("phase_progression"),
                contribution_type=custom.get("contribution_type"),
                contribution_target=custom.get("contribution_target"),
                coworkers=custom.get("coworkers"),
            ),
