...
**Expected behavior:** Triage each task with ALL fields. Assign agents.
...
- **triage-inbox**: Triage unassigned inbox tasks — set all fields, assign agents
  When: heartbeat with unassigned tasks in inbox
  Boundary: Cannot override PO decisions. Cannot change delivery phase.
- **contribution-check**: Verify contributions before tasks advance to work
